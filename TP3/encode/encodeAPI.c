...
uint8_t* varBinding_gets(long reqID, ObjectName_t* names[], char* cs, long v) {
...
uint8_t* getsHandler(long reqID, char* args[], int n) {
	...
	return varBinding_gets(reqID, oids, c_str, v);
}
